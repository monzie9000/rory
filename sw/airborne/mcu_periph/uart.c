...
#if USE_UART0
    case 0:
        send_uart0_err(trans, dev);
        break;
#endif
#if USE_UART1
    case 1:
        send_uart1_err(trans, dev);
        break;
#endif
#if USE_UART2
    case 2:
        send_uart2_err(trans, dev);
        break;
#endif
#if USE_UART3
    case 3:
        send_uart3_err(trans, dev);
        break;
#endif
#if USE_UART4
    case 4:
        send_uart4_err(trans, dev);
        break;
#endif
#if USE_UART5
    case 5:
        send_uart5_err(trans, dev);
        break;
#endif
#if USE_UART6
    case 6:
        send_uart6_err(trans, dev);
        break;
#endif
#if USE_UART7
    case 7:
        send_uart7_err(trans, dev);
        break;
#endif
#if USE_UART8
    case 8:
        send_uart8_err(trans, dev);
        break;
#endif
    default:
        break;
