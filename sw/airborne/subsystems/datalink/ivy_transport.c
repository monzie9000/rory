...
static int check_free_space(struct ivy_transport *p __attribute__((unused)), uint8_t len __attribute__((unused)))
{
    return TRUE;
}
...
static int null_function(struct ivy_transport *p __attribute__((unused)))
{
    return 0;
}
