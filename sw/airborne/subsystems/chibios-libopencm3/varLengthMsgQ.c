...
const char*     varLenMsgQueueError (int32_t messIndex)
{
    switch (messIndex)
    {
    case ERROR_MAILBOX_FULL:
        return "mailbox full";
    case ERROR_MAILBOX_FAIL:
        return "mailbox fail";
    case ERROR_CHUNKBUFFER_INVALID:
        return "chunkbuffer invalid";
    case ERROR_CIRCULAR_BUFFER_FULL:
        return "circular buffer full";
    case ERROR_CIRCULAR_BUFFER_UNSYNC:
        return "circular buffer unsync";
    }
