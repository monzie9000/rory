...
void kalmanInit(TypeKalman *k)
{
    ...
    k->W[0][0] = MarcheAleaAccelerometre * MarcheAleaAccelerometre;
    k->W[0][1] = 0;
    k->W[1][0] = 0;
    k->W[1][1] = MarcheAleaBiaisAltimetre * MarcheAleaBiaisAltimetre;
    ...
    k->Md[0][0] = pow(k->Te, 1.5) / 2;
    k->Md[0][1] = 0;
    k->Md[1][0] = pow(k->Te, 0.5);
    k->Md[1][1] = 0;
    k->Md[2][0] = 0;
    k->Md[2][1] = pow(k->Te, 0.5);
}
